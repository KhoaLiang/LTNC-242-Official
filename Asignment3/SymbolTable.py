...
#         # elif cmd_type == "PRINT":
#         #     # Collect all symbols in the stack in order
#         #     symbols = [
...
#             # Create reverse_symbols with symbols in reverse order
#             reverse_symbols = symbols[::-1]
            
#             return stack, results + [" ".join(symbols), " ".join(reverse_symbols)]
...
def simulate(list_of_commands):
    ...
    def process_command(state, command):
        ...
        # the most basic the works
        # elif cmd_type == "PRINT":
        #     # Collect all symbols in the stack in declaration order
        #     declared_order = []
        #     for block in reversed(stack):  # Iterate from the bottom-most block to the top-most block
        #         for name in block:
        #             if name not in declared_order:
        ...
        #     ]
        #     symbols_to_print = []
        #     return stack, results + [" ".join(declared_order), " ".join(symbols), " ".join(symbols_to_print)]
        ...
        # error when having multiple instance
        # elif cmd_type == "PRINT":
        #     # Collect all symbols in the stack in declaration order
        #     declared_order = []
        #     for block in reversed(stack):  # Iterate from the bottom-most block to the top-most block
        ...
        #     return stack, results + [" ".join(symbols_to_print)]
